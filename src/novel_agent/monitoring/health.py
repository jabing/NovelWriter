...
from src.novel_agent.monitoring.alerts import AlertManager, AlertSeverity, AlertType, get_alert_manager
...
async def check_memory_system() -> HealthCheckResult:
    ...
    try:
        from src.novel_agent.memory import MemSearchAdapter
...
async def check_database() -> HealthCheckResult:
    ...
    db_status = {}
    try:
        from src.novel_agent.db import Neo4jClient, PostgresClient, VectorStore
...
async def check_knowledge_graph() -> HealthCheckResult:
    ...
    try:
        from src.novel_agent.db import Neo4jClient
