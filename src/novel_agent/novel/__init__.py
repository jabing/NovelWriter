...
from src.novel_agent.novel.glossary import GlossaryManager, TermStatus
...
from src.novel_agent.novel.schemas import AgentType, Genre, Language, VersionMetadata
from src.novel_agent.novel.structured_input import (
    CharacterInScene,
    LocationSpec,
...
from src.novel_agent.novel.validators import (
    ContinuityValidator,
    ValidationError,
    ValidationResult,
)
from src.novel_agent.novel.version_control import (
    VersionChangeType,
