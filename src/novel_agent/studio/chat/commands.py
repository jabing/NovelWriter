...
from src.novel_agent.studio.chat.streaming_progress import ProgressFormatter
...
class CommandRegistry:
    ...
    def _get_pipeline(self):
        ...
        if self._pipeline is None:
            from src.novel_agent.agents.content_pipeline import ContentPipeline
            from src.novel_agent.llm.final_model_config import DOMESTIC_MODELS
    ...
    def _get_discussion_planner(self):
        ...
        if self._discussion_planner is None:
            from src.novel_agent.llm.final_model_config import DOMESTIC_MODELS
            from src.novel_agent.llm.glm import GLMLLM
            from src.novel_agent.studio.chat.discussion_planner import DiscussionPlanner
    ...
    def _get_planner(self):
        ...
        if self._planner is None:
            from src.novel_agent.agents.project_planner import ProjectPlanner
            from src.novel_agent.llm.final_model_config import DOMESTIC_MODELS
            from src.novel_agent.llm.glm import GLMLLM
  ...
  **Language:** zh
  ...
  💡 Your feedback helps the AI learn your preferences!"""
    ...
    async def _handle_set(self, args: list[str]) -> str:
        ...
        """
        from src.novel_agent.studio.core.settings import QUALITY_PRESETS, get_settings_manager
