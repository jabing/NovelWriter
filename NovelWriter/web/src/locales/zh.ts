export default {
  ...
  publish: {
    ...
    selectProject: '选择项目',
    selectPlatform: '选择平台',
    selectProjectPlaceholder: '选择要发布的项目',
    selectPlatforms: '选择平台',
    selectPlatformsPlaceholder: '选择目标发布平台',
    selectChapters: '选择章节',
    selectChaptersPlaceholder: '选择要发布的章节',
    selectAll: '全选',
    deselectAll: '取消全选',
    chapterCount: '已选择 {count} 个章节',
    noProjects: '暂无可用项目',
    noPlatforms: '暂无可用平台',
    noChapters: '暂无可用章节',
    readyToPublish: '准备发布',
    publishingProgress: '发布进度',
    publishSuccess: '发布成功',
    success: '发布成功',
    publishFailed: '发布失败',
    error: '发布失败',
    publishInProgress: '正在发布中...',
    platformStatus: {
      active: '正常',
      inactive: '停用',
      maintenance: '维护中'
    ...
    validation: {
      selectProject: '请选择项目',
      selectPlatforms: '请至少选择一个平台',
      selectChapters: '请至少选择一个章节'
    },
    progress: {
      preparing: '准备中...',
      uploading: '正在上传到 {platform}...',
      completed: '已完成',
      failed: '失败'
    }
  },
  ...
  comments: {
    ...
    loading: '加载评论中...',
    noComments: '暂无评论',
    noCommentsDesc: '当读者开始与您的作品互动时，评论将显示在这里。',
    loadError: '加载评论失败，请重试。',
    retry: '重试',
    prev: '上一页',
    next: '下一页',
    showing: '显示第 {from} 到 {to} 条，共 {total} 条评论',
    sentiment: {
      positive: '积极',
      neutral: '中性',
      negative: '消极'
