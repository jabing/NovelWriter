...
class TestSymbolIndex:
    ...
    def test_update_single_symbol(self, index: SymbolIndex) -> None:
        ...
        symbol = CharacterSymbol(
            ...
            definition_range={"start_line": 0, "end_line": 0, "start_character": 0, "end_character": 10},
            age=42,
        )
    ...
    def test_search_with_type_filter(self, index: SymbolIndex) -> None:
        ...
        index.update(LocationSymbol(
            id="loc_1",
            name="John's House",
            novel_id="novel_1",
            definition_uri="file:///test.md",
            definition_range={"start_line": 1, "end_line": 1, "start_character": 0, "end_character": 10},
        ))
...
class TestLRUEviction:
    ...
    def test_lru_eviction(self, small_index: SymbolIndex) -> None:
        ...
        for i in range(4):
            small_index.update(CharacterSymbol(
                id=f"char_{i}_{i}",
                name=f"Character {i}",
                novel_id="novel_1",
                definition_uri="file:///test.md",
    ...
    def test_lru_access_prevents_eviction(self, small_index: SymbolIndex) -> None:
        ...
        small_index.update(CharacterSymbol(
            ...
            novel_id="novel_1",
            definition_uri="file:///test.md",
            definition_range={"start_line": 3, "end_line": 3, "start_character": 0, "end_character": 10},
        ))
...
class TestFindSymbolAtPosition:
    ...
    def test_find_symbol_at_position_exact_match(self, index: SymbolIndex) -> None:
        ...
        index.update(CharacterSymbol(
            ...
            novel_id="novel_1",
            definition_uri="file:///test.md",
            definition_range={"start_line": 5, "end_line": 5, "start_character": 0, "end_character": 20},
        ))
    ...
    def test_find_symbol_at_position_multiple_symbols(self, index: SymbolIndex) -> None:
        ...
        index.update(CharacterSymbol(
            ...
            novel_id="novel_1",
            definition_uri="file:///test.md",
            definition_range={"start_line": 10, "end_line": 10, "start_character": 0, "end_character": 20},
        ))
