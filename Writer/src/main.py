...
def health_check() -> None:
    ...
    from src import DATA_DIR, NOVELS_DIR, OPENVIKING_DIR
...
def create(title: str, genre: str, chapters: int) -> None:
    ...
    from src.studio.core.state import NovelProject, ProjectStatus, get_studio_state
...
def update(
    ...
    from src.studio.core.state import ProjectStatus, get_studio_state
...
def studio() -> None:
    ...
    try:
        from src.studio.chat.flet_app import run_flet_chat_studio
...
def health() -> None:
    ...
    async def run_health_checks():
        from src.monitoring.health import HealthMonitor, HealthStatus, get_health_monitor
        ...
        if not health_monitor._checks:
            ...
            async def check_config():
                from src.monitoring.health import HealthCheckResult
...
def alerts(limit: int, severity: str | None) -> None:
    ...
    from src.monitoring.alerts import AlertManager, AlertSeverity, get_alert_manager
