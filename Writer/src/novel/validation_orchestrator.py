...
if TYPE_CHECKING:
    from src.db.pinecone_client import VectorStore
    from src.db.postgres_client import PostgresClient
    from src.novel.character_profile import CharacterProfileManager
    ...
    from src.novel.timeline_validator import TimelineValidator
