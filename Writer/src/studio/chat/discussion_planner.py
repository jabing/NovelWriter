...
from src.studio.chat.creative_cache import DiscussionCache
from src.studio.chat.streaming_progress import (
    GenerationStage,
    ProgressUpdate,
)
...
请分析用户想要修改什么。"""
    ...
    async def confirm_and_create_with_cover(
        ...
        if generate_cover and project:
            try:
                from src.studio.chat.cover_integration import CoverIntegration
