@echo off
REM CI Test Script for Phase 1 (Windows)
REM This script runs all Phase 1 tests with coverage and reporting
...
REM Run Phase 1 tests with coverage
pytest tests/phase1/ ^
